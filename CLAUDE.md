...
- **Contrastá toda cita del CSV contra `docs/MATRIZ_LEGAL_V4.md` y `docs/normativa/`.** El CSV tiene errores comprobados —cita `Res. SS SG. 215/15` 35 veces y la correcta es la **215/2017**, confirmado por el visto de la propia Res. 231/2025— y no menciona ni la 210/2025 ni la 231/2025, que son las normas centrales del canal electrónico. Ver `docs/normativa/CATALOGO.md` §3.
