...
| `ley-6822-2021-oficial-firmada.pdf` | **Ley N° 6822/2021** — la misma ley, en la edición oficial **firmada digitalmente** (48 p; firma de Lucas Atilio Sotomayor Llano, 26-ene-2022). SHA-256 `bfac93b1…0c11` | Respaldo de mayor valor probatorio que `ley-6822-2021.pdf`, que es una conversión desde Word sin firma. Las citas siguen apuntando a aquella por número de artículo; la paginación difiere. Estaba sin versionar en el checkout principal desde el 03-sep-2026; entra el 14-sep-2026 |
...
| `MIC-Res-1384-2022-comunicacion-inicio-servicios-confianza-no-cualificados.pdf` | **Res. MIC N° 1384/2022** — Reglamenta el proceso de comunicación de inicio y modificación de la prestación de servicios de confianza **no cualificados** (06-oct-2022; 2 p, **escaneada, sin capa de texto**). Aprueba el formulario **FOR-ICPP-02** (Anexo I) y el perfil de certificado del prestador no cualificado (Anexo II). **Los anexos no vienen en el PDF** | El trámite del escenario E2 (prestador no cualificado) de `docs/VALIDACION_LEGAL_FIRMA_INTERNA.md` §4, que el mecanismo interno (E1) no dispara. Sirve sobre todo al proyecto Firmas-NoCualificadas. Leída de primera mano el 14-sep-2026 |
| `MIC-Res-262-2024-perfil-certificado-prestador-no-cualificado-DOC-ICPP-20-v2.pdf` | **Res. MIC N° 262/2024** — Aprueba el perfil del certificado del prestador no cualificado de servicios de confianza, **DOC-ICPP-20 versión 2.0** (04-abr-2024; 2 p) | Reemplaza el perfil que aprobó el Anexo II de la 1384/2022. Ver en `docs/firma-cualificada/referencias/INDICE.md` la nota sobre la versión 2.0 del `DOC-ICPP-20`. Solo se leyó el encabezado (14-sep-2026) |
