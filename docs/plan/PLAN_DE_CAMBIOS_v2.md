...
| **L5b · Confirmación, notificaciones y devoluciones** | CHG-40/42/43/44/45, CHG-47/D-14 (Pv2-B), **flujo de seguimiento de devoluciones (D-02) + vista en consola**, CMP-05/06 (ruta `/verificar/<código>`) | ✅ desbloqueado (D-05, D-17, D-18); D-19 con datos parametrizados; requiere L5a | CPC descargable solo con pago confirmado; envío automático con reintentos y acuse; devolución seguible de punta a punta con evidencia |
