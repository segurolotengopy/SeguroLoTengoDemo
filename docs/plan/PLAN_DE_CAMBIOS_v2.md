...
| **L5c · Entrega con acuse y verificación** | CHG-44 (job de entrega + reintentos + acuse, D-18), CMP-05, CMP-06 (ruta `/verificar/<código>`) | ✅ desbloqueado (D-18); requiere L5b | Envío automático con reintentos y acuse; QR verificable de punta a punta |
| **L5d · Pantalla B y devoluciones** | CHG-47/D-14 (Pv2-B conectada + envío efectivo a Alianza + trazabilidad), **flujo de seguimiento de devoluciones (D-02) + vista en consola** | ✅ desbloqueado (D-02, D-14); requiere L5b | Devolución seguible de punta a punta con evidencia |
