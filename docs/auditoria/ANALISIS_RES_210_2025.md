...
>
> **v4 y v5 (mismo día):** se asentó la desambiguación entre la **215/17**
...
El pedido nombraba una «RA 215/17». El PDF analizado (entregado como
...
> **Corregido de nuevo el 04-sep-2026 (v6), con el texto oficial a la vista.**
> La resolución de registro de planes y modelos es la **Res. SS.SG. N.º
> 215/17** (28-dic-2017), leída de primera mano y guardada en
> `docs/normativa/`. La «corrección» del 26-ago que pasó las citas a
> «215/2025» fue el error: esa numeración salió del archivo `215_2025.pdf`,
> que contiene la 210/2025. Las citas del repositorio volvieron a «215/17» y
> el test de higiene rechaza ahora «215/15» y «215/2025».

Dos resoluciones que **no** hay que confundir, porque el
proyecto usa las dos:

- **Res. SIS 215/17** — modelos de propuesta y póliza, numeración,
  ...
  resolutivos 7, 9 y 14. Su texto oficial está en `docs/normativa/` desde el 04-sep-2026.
...
- La **numeración de la resolución de modelos** se corrige: es **215/17**,
  no «215/15» (§0).
...
| 14 | Modelos y contenido contractual | **Res. 215/17** — no «215/15» ni «215/2025» | ✅ estructura de Solicitud/FIPF conforme; cita corregida en CSV, `CLAUDE.md` y `src/` |
...
(215/17, derogadas prohibidas, PDFs oficiales a `docs/normativa/`).
...
1. ✅ **APLICADA — CSV de cumplimiento.** Errata **«215/15» → «215/2025»** *(revertida el 04-sep-2026: la forma correcta es «215/17», ver v6 arriba)*
...
2. ⏳ **PREPARADA — `docs/normativa/`.** No se pudieron incorporar los PDF:
   ...
   está, empezando por la **215/17**) y prioridad B (las que el criterio
