...
/**
 * Qué literal firma la autorización y con qué versión queda asentado. Hasta el
 * 16-sep-2026 se elegía a import-time entre el aviso de P3 y la aceptación
 * agrupada del flujo v3; con ese flujo retirado, queda el aviso de P3.
 */
export const TEXTO_AUTORIZACION_VIGENTE = TEXTO_AUTORIZACION_INICIAL_P3;

export const VERSION_AUTORIZACION_VIGENTE = VERSION_AVISO_P3;
