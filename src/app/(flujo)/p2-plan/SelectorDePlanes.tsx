  ...
  return (
    ...
    >
        ...
        {COBERTURAS.map(({ etiqueta, valor, destacada }) => (
          <div
            ...
            className={`flex flex-col gap-0.5 ${
              destacada ? "border-t border-borde-tenue pt-2" : ""
            }`}
          >
            ...
            <dd
              className={
                destacada
                  ? "text-base font-bold text-titulo tabular-nums"
                  : "text-sm font-semibold text-titulo tabular-nums"
              }
            >
              {valor(plan)}
            </dd>
      ...
      <button
        ...
        className={`inline-flex h-11 w-full items-center justify-center rounded-lg px-5 text-sm font-bold tracking-wide uppercase transition-colors ${
          elegido
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-4">
        <div className="leading-tight">
          <h2 className="text-xl font-bold text-titulo sm:text-2xl">{NOMBRE_PRODUCTO}</h2>
      ...
      <section className="flex flex-col gap-3">
        ...
        >
          {plan
            ? enProceso
              ? "Guardando…"
              : `Seleccionar ${plan.nombre} y continuar →`
        ...
        <div className="flex flex-col gap-1 text-xs text-cuerpo">
          <p>
            Al continuar se selecciona el plan: todavía no se contrata ni se firma.
          </p>
          <p>
            Antes de la firma vas a poder revisar y descargar la Solicitud, el FIPF y las
            condiciones.
          </p>
        </div>
      </section>
